...
namespace numpp::differentiation::finite{
  ...
  /**
    \defgroup numpp_differentiation_finite_forward Forward Finite Differentiation
    \ingroup numpp_differentiation_finite

    \brief Calculates forward finite derivative \f$\frac{f(x+h)-f(x)}{h}\f$
    ...
    \warning If you are unsure about parameter h use function with the automatically calculated overload!
